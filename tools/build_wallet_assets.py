#!/usr/bin/env python3
"""Generate Alma Apple Wallet pass assets.
...
Source: icono alma.png + logo alma.png at project root.
"""
...
SRC_LOGO = os.path.join(ROOT, "brand", "logo alma.png")
SRC_ICON = os.path.join(ROOT, "brand", "icono alma.png")
...
def make_strip(width: int, height: int) -> Image.Image:
    ...
    Rings are drawn at 100% (full circles) representing the three Alma rings
...
def main() -> int:
    ...
    # Replace ophelia-logo.png anchor (used by findAssetDir) with Alma icon at higher res
    print("\n── Anchor (ophelia-logo.png replaced by Alma) ──")
