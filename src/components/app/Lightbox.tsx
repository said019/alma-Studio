  ...
  return (
    <>
      <button type="button" className={cn("relative group cursor-zoom-in", className)} onClick={() => setOpen(true)}>
        ...
        <span className="absolute inset-0 bg-inverse/50 opacity-0 group-hover:opacity-100 transition-opacity rounded-xl flex items-center justify-center gap-2 text-canvas text-sm">
