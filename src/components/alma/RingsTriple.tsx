...
const DEFAULT_GEOMETRY: Record<AlmaRing["key"], { radius: number; stroke: number }> = {
...
const EASE_OUT_ALMA = "cubic-bezier(0.23, 1, 0.32, 1)";
  ...
  return (
    <div
      className={cn(
        ...
        "alma-rings-shell",
        light
          ? "border-[#A48D78]/12 bg-[radial-gradient(circle_at_34%_26%,rgba(255,247,242,0.96),rgba(255,240,228,0.92)_48%,rgba(252,230,225,0.92)_100%)] shadow-[inset_0_1px_8px_rgba(255,255,255,0.72),0_24px_70px_rgba(118,33,77,0.10)]"
    ...
    >
      <div
        className={cn(
          ...
          light
            ? "border-[#A48D78]/8 bg-[radial-gradient(circle_at_50%_50%,rgba(255,255,255,0.62),transparent_62%)]"
          ...
          return (
            <g key={ring.key}>
              ...
              <circle
                ...
                style={{
                  transition: `stroke-dashoffset 1100ms ${EASE_OUT_ALMA}`,
      ...
      <div
        ...
        style={{
          ...
          transform: animated.some((v) => v > 0) || rings.every((r) => r.progress === 0)
            ? "translateY(0)"
            : "translateY(4px)",
          transition: `opacity 600ms ${EASE_OUT_ALMA} 250ms, transform 600ms ${EASE_OUT_ALMA} 250ms`,
        }}
      >
        <span
          className={cn(
            "text-[0.62rem] font-semibold uppercase tracking-[0.22em]",
            light ? "text-[#A48D78]/70" : "text-[#E6DAC8] drop-shadow-[0_2px_8px_rgba(46,32,28,0.45)]",
          )}
        >
          {centerLabel}
        </span>
        <span
          className={cn(
            ...
            light ? "text-[#43392F]" : "text-[#FAF9F6] drop-shadow-[0_3px_14px_rgba(46,32,28,0.5)]",
          )}
        >
          {centerValue}
        </span>
        <span
          className={cn(
            ...
            light ? "text-[#8C7A68]" : "text-[#FAF9F6] drop-shadow-[0_2px_10px_rgba(46,32,28,0.5)]",
          )}
        >
          {centerSub}
        </span>
