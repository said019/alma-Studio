...
export default function UpdateBanner() {
  ...
  return (
    ...
    >
      <div className="pointer-events-auto flex w-full max-w-[440px] items-center gap-3 rounded-2xl bg-inverse px-4 py-3 text-inverse-foreground shadow-[0_12px_34px_rgba(0,0,0,0.28)]">
