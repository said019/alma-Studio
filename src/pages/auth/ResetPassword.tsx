    ...
    >
      {done ? (
        <div
          ...
          style={{ backgroundColor: ALMA.blush, border: `1px solid ${ALMA.olive}40` }}
        >
          <span className="grid h-10 w-10 place-items-center rounded-full shrink-0" style={{ backgroundColor: ALMA.olive, color: ALMA.cream }}>
            <CheckCircle2 size={18} />
          </span>
          <div>
            <p className="text-[0.96rem] leading-[1.5]" style={{ color: ALMA.ink }}>
        ...
        <div
          role="alert"
          className="flex items-start gap-4 rounded-2xl px-5 py-5"
          style={{ backgroundColor: `${ALMA.destructive}10`, border: `1px solid ${ALMA.destructive}40`, color: ALMA.destructive }}
        >
