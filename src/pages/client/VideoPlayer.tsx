...
import { AlmaVideoPlayer, AlmaLoader, AlmaProgressBar } from "@/components/app/AlmaVideoPlayer";
...
const YouTubeEmbed = ({ url }: { url: string }) => {
  ...
  if (!id) return null;
  return (
    <div className="aspect-video w-full rounded-3xl overflow-hidden" style={{ backgroundColor: ALMA.ink }}>
      <iframe
        ...
        {isLoading ? (
          ...
          <>
            <Section>
              {isDriveVideo ? (
                streamLoading ? (
                  <AlmaLoader label="Preparando tu clase…" sublabel="Cargando el reproductor" />
                ) : streamError ? (
                  <div
                  ...
                  >
                    <span
                      ...
                      style={{ backgroundColor: streamErrReason === "purchasable" ? ALMA.orange : ALMA.berry, color: ALMA.cream }}
                    >
                    ...
                    <div>
                      <h3
                        ...
                        style={{ color: ALMA.ink, fontSize: "clamp(1.5rem, 2.4vw, 2rem)" }}
                      >
                        {streamErrStatus === 404
                          ? "Video no disponible"
                      ...
                      <p
                        ...
                        style={{ color: ALMA.ink, opacity: 0.7 }}
                      >
                        {streamErrStatus === 404
                ...
                >
                  ...
                  <div>
                    <h3 className="font-bebas leading-tight" style={{ color: ALMA.ink, fontSize: "clamp(1.5rem, 2.4vw, 2rem)" }}>
                      Acceso individual
                    </h3>
                    <p className="mt-2 text-[0.92rem]" style={{ color: ALMA.ink, opacity: 0.7 }}>
            ...
            {purchaseStep === "upload" && (
              <Section title="Subir comprobante">
                <div className="rounded-3xl p-5 sm:p-7 grid gap-5" style={{ backgroundColor: ALMA.cream, border: `1px solid ${ALMA.border}` }}>
                  <div>
                    ...
                    >
                      ...
                      <p className="text-[0.9rem] font-medium" style={{ color: ALMA.ink }}>
            ...
            {purchaseStep === "done" && (
              <Section>
                ...
                >
                  ...
                  <p className="mt-2 text-[0.92rem] max-w-[40ch] mx-auto" style={{ color: ALMA.ink, opacity: 0.7 }}>
            ...
            <Section>
              <div className="flex flex-col gap-4">
                <div className="flex flex-wrap items-baseline justify-between gap-3">
                  <h1 className="font-bebas leading-tight" style={{ color: ALMA.ink, fontSize: "clamp(1.7rem, 3vw, 2.5rem)" }}>
                    {video.title}
                  </h1>
                ...
                {video.instructor_name && (
                  <p className="text-[0.84rem] uppercase tracking-[0.18em]" style={{ color: ALMA.ink, opacity: 0.6 }}>
                    Por {video.instructor_name}
                  </p>
                )}
                {video.description && (
                  <p className="text-[0.95rem] leading-[1.7] max-w-[70ch]" style={{ color: ALMA.ink, opacity: 0.78 }}>
                    {video.description}
                  </p>
                )}
              </div>
