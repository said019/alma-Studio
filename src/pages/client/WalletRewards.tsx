      ...
      <AppShell hideGreeting>
          ...
          <Section title="Tu próximo logro">
            ...
            >
              ...
              {ms.milestones.some((m) => m.achieved) && (
                ...
                >
                  <p className="text-[0.62rem] uppercase tracking-[0.22em] mb-3" style={{ color: ALMA.ink, opacity: 0.55 }}>
        ...
        {ms && !ms.next_milestone && ms.milestones.length > 0 && ms.milestones.every((m) => m.achieved) && (
          <Section title="Logros completos">
            ...
            >
              <Trophy size={28} style={{ color: ALMA.orange, margin: "0 auto" }} />
              <p className="mt-3 font-bebas" style={{ color: ALMA.ink, fontSize: "1.25rem" }}>
                ...
                return (
                  ...
                  >
                    <div className="flex items-start gap-3">
                      ...
                      <div className="min-w-0 flex-1">
                        <h3 className="font-bebas leading-tight" style={{ color: ALMA.ink, fontSize: "1.2rem" }}>
                          {r.name}
                        </h3>
                        {r.description && (
                          <p className="mt-1 text-[0.84rem] leading-[1.55]" style={{ color: ALMA.ink, opacity: 0.65 }}>
                    ...
                    <div>
                      <div className="flex items-center justify-between text-[0.72rem] uppercase tracking-[0.18em]">
                        <span style={{ color: ALMA.berry }}>{cost} pts</span>
                        {stockLeft != null && (
                          <span style={{ color: ALMA.ink, opacity: 0.55 }}>{stockLeft} disponibles</span>
                        )}
                      </div>
                      <div className="mt-2 h-1 rounded-full overflow-hidden" style={{ backgroundColor: ALMA.cream }}>
                        <div
                          className="h-full rounded-full transition-[width] duration-700"
                          style={{ width: `${progress}%`, backgroundColor: canRedeem ? ALMA.olive : ALMA.coral }}
                        />
                      </div>
                    </div>
                    ...
                    <button
                      ...
                      style={{
                        backgroundColor: canRedeem ? ALMA.berry : "transparent",
                        color: canRedeem ? ALMA.cream : ALMA.ink,
                        border: canRedeem ? "0" : `1px solid ${ALMA.border}`,
                      }}
                    >
