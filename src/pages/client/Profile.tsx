      ...
      <AppShell hideGreeting>
        ...
        >
          ...
          <div className="min-w-0 flex-1">
            ...
            {phone && (
              <p className="text-[0.82rem] mt-0.5 truncate" style={{ color: ALMA.ink, opacity: 0.55 }}>
                {phone}
              </p>
            )}
            <div className="mt-3">
        ...
        {user?.id && (
          <Section title="Mi código de acceso">
            <div className="flex flex-col items-center gap-3 rounded-3xl bg-white/80 p-6 text-center">
              ...
              <p className="text-xs" style={{ color: ALMA.ink, opacity: 0.55 }}>
              ...
              <button
                ...
                onClick={async () => {
                  try {
                    ...
                    const el = document.getElementById("alma-copy-feedback");
                    if (el) {
                ...
                style={{ backgroundColor: ALMA.berry, color: ALMA.cream }}
              >
                <span id="alma-copy-feedback">Copiar código</span>
              </button>
            </div>
          </Section>
        )}
        ...
        <p className="mt-12 text-[0.7rem] uppercase tracking-[0.18em]" style={{ color: ALMA.ink, opacity: 0.4 }}>
