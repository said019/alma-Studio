                      ...
                      <div className="flex items-center gap-2">
                        ...
                        {isCancellable && (
                          <button
                            ...
                            style={{ color: ALMA.destructive, border: `1px solid ${ALMA.destructive}30` }}
                          >
                            <X size={13} />
                          </button>
                        )}
        ...
        >
          <DialogContent>
            ...
            <div className="space-y-5 py-2">
              <div>
                <p className="text-[0.7rem] font-medium uppercase tracking-[0.22em] mb-2" style={{ color: ALMA.ink, opacity: 0.6 }}>
                  Calificación
                </p>
                  ...
                  {[1, 2, 3, 4, 5].map((s) => (
                    ...
                    >
                      <Star
                        ...
                        strokeWidth={1.5}
                        style={{
                          color: s <= rating ? ALMA.orange : ALMA.ink,
                          opacity: s <= rating ? 1 : 0.3,
                          fill: s <= rating ? ALMA.orange : "transparent",
                        }}
                      />
                    </button>
                  ))}
