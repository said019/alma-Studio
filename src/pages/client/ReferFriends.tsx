    ...
    if (navigator.share) {
      try {
        await navigator.share({
          title: "Te invito a Alma Movement",
          ...
          <Section>
            ...
            >
              <span
                ...
                style={{ backgroundColor: ALMA.coral, color: ALMA.cream }}
              >
                <Sparkles size={20} />
              </span>
              <div>
                <p className="text-[0.62rem] font-medium uppercase tracking-[0.24em]" style={{ color: ALMA.berry }}>
                  Tu código
                </p>
                <p
                  className="font-bebas mt-2 tracking-[0.18em] tabular-nums break-all"
                  style={{ color: ALMA.ink, fontSize: "clamp(2.2rem, 5vw, 3.4rem)" }}
                >
                  {code || "—"}
                </p>
              </div>
        ...
        <Section title="Cómo funciona">
          <ul className="list-none m-0 p-0">
            {[
              ...
              >
                <span className="font-bebas text-[1rem]" style={{ color: ALMA.coral }}>
                  {step.tag}
                </span>
