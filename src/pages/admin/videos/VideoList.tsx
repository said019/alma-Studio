 ...
 *  cae a un placeholder estilo Alma con ícono de play. */
  ...
  if (!url || broken) {
    return (
      <div
        ...
        style={{ background: `linear-gradient(135deg, ${ALMA.blush} 0%, ${ALMA.cream} 100%)` }}
      >
        <span
          className="grid h-10 w-10 place-items-center rounded-full"
          style={{ backgroundColor: ALMA.berry, color: ALMA.cream }}
        >
          <Play size={14} fill={ALMA.cream} className="ml-0.5" />
        </span>
      </div>
    );
  }
