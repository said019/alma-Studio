...
const UPLOAD_RESUME_KEY = "alma_video_upload_v1";
            ...
            <section className="space-y-4 rounded-xl border p-5">
              ...
              {editId && existing?.drive_file_id && !videoFileName && (
                <div
                  ...
                  style={{ borderColor: ALMA.border, backgroundColor: ALMA.blush }}
                >
                  <CheckCircle2 size={18} style={{ color: ALMA.olive }} />
                  <div className="text-sm">
                    <p className="font-medium" style={{ color: ALMA.ink }}>
                      Ya hay un video guardado.
                    </p>
                    <p className="text-xs" style={{ color: ALMA.ink, opacity: 0.65 }}>
