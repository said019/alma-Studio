...
const FALLBACK_CLASS_TYPES: ClassTypeRow[] = [
  { id: "ct1", name: "Pilates Reformer", subtitle: "Fuerza y control en equipo", description: "Trabajo de cuerpo completo en el reformer: resistencia, alineación y control en grupos pequeños.", category: "reformer_tower", intensity: "media", color: COLOR.ink, emoji: "sparkles", level: "Todos los niveles", duration_min: 50, capacity: 4, is_active: true, sort_order: 1 },
  { id: "ct2", name: "Pilates Tower", subtitle: "Movilidad y precisión", description: "Trabajo en torre que combina resistencia y movilidad para una postura fuerte y consciente.", category: "reformer_tower", intensity: "media", color: COLOR.ink, emoji: "sparkles", level: "Todos los niveles", duration_min: 50, capacity: 4, is_active: true, sort_order: 2 },
  { id: "ct3", name: "Pilates Mat", subtitle: "Core y conexión", description: "Pilates en tapete con accesorios: core profundo, control y respiración consciente.", category: "studio", intensity: "media", color: COLOR.accentStrong, emoji: "sparkles", level: "Todos los niveles", duration_min: 50, capacity: 8, is_active: true, sort_order: 3 },
  { id: "ct4", name: "Barre", subtitle: "Postura y tono", description: "Energía, fuerza y postura en una clase cercana apta para todos los niveles.", category: "studio", intensity: "media", color: COLOR.accentStrong, emoji: "sparkles", level: "Todos los niveles", duration_min: 50, capacity: 8, is_active: true, sort_order: 4 },
  { id: "ct5", name: "Sculpt", subtitle: "Fuerza funcional", description: "Trabajo de tonificación y fuerza funcional para todo el cuerpo, con ritmo y constancia.", category: "studio", intensity: "media", color: COLOR.accentStrong, emoji: "sparkles", level: "Todos los niveles", duration_min: 50, capacity: 8, is_active: true, sort_order: 5 },
];
  ...
  return (
    <div className="min-h-screen text-[color:var(--ink)] [--ink:#43392F] [--ink-deep:#241B1A] [--cream:#FAF9F6] [--blush:#E6DAC8] [--berry:#6E5A46]" style={{ backgroundColor: COLOR.canvas }}>
      ...
      >
        ...
        >
          <div className="min-h-0 overflow-hidden">
            <ul className="flex flex-col gap-1 px-5 py-4 list-none m-0" style={{ backgroundColor: COLOR.canvas, borderTop: `1px solid ${COLOR.line}` }}>
              {[
                { label: "Estudio", id: "estudio" },
                { label: "Clases", id: "clases" },
                { label: "Horario", id: "horario" },
      ...
      <section id="top" className="relative overflow-hidden px-5 sm:px-8 lg:px-12 pt-32 sm:pt-36 pb-14 lg:pb-20">
        <div className="pointer-events-none absolute inset-0" style={{ background: `radial-gradient(115% 85% at 88% 8%, ${COLOR.sunken}80 0%, transparent 56%)` }} />
        <div className="relative mx-auto max-w-[1320px] grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-6 items-center min-h-[68vh] lg:min-h-[76vh]">
          ...
          <div className="order-2 lg:order-1 lg:col-span-7" data-stagger>
            <div className="flex items-center gap-3" data-stagger-item>
              <span className="inline-block h-px w-10" style={{ backgroundColor: COLOR.ink, opacity: 0.55 }} />
            ...
            <h1 data-stagger-item className="font-display mt-6 leading-[0.98]" style={{ color: COLOR.ink, fontSize: "clamp(2.9rem, 7.6vw, 6.6rem)", fontWeight: 380 }}>
              Donde el movimiento
            ...
            <div data-stagger-item className="mt-9 flex flex-wrap items-center gap-4">
              ...
              >
                ...
                <span className="grid h-7 w-7 place-items-center rounded-full bg-white/15 transition-transform duration-300 group-hover:translate-x-1" style={{ transitionTimingFunction: "var(--ease-out)" }}>
        ...
        <div className="relative mx-auto max-w-[1320px] mt-10 sm:mt-14">
          <p className="nums border-t pt-4 text-[0.74rem] uppercase tracking-[0.22em]" style={{ borderColor: COLOR.line, color: COLOR.accentStrong }}>
      ...
      <section id="estudio" className="relative px-5 sm:px-8 lg:px-12 py-28 lg:py-40">
        <div className="mx-auto max-w-[1320px] grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 items-start">
          <div className="lg:col-span-5 reveal opacity-0 translate-y-8 transition-all duration-700">
            <div className="relative aspect-[4/5] overflow-hidden rounded-[24px] flex flex-col justify-between p-8 sm:p-10" style={{ backgroundColor: COLOR.sunken }}>
              ...
              <span className="relative text-[0.62rem] uppercase tracking-[0.28em]" style={{ color: COLOR.accentStrong }}>Move with intention</span>
              <div className="relative">
                <p className="font-display leading-[1.1]" style={{ color: COLOR.ink, fontSize: "clamp(1.7rem, 2.6vw, 2.5rem)", fontWeight: 380 }}>
                  Grupos pequeños, técnica cuidada y atención que se nota.
                </p>
                <div className="mt-7 grid grid-cols-2 gap-4">
                  <div>
                    <div className="font-display nums leading-none" style={{ color: COLOR.accentStrong, fontSize: "2.5rem" }}>4</div>
                    <div className="text-[0.6rem] uppercase tracking-[0.18em] mt-1.5" style={{ color: COLOR.ink, opacity: 0.6 }}>en equipo</div>
                  </div>
                  <div>
                    <div className="font-display nums leading-none" style={{ color: COLOR.accentStrong, fontSize: "2.5rem" }}>50<span className="text-[1.1rem] ml-0.5">min</span></div>
                    <div className="text-[0.6rem] uppercase tracking-[0.18em] mt-1.5" style={{ color: COLOR.ink, opacity: 0.6 }}>cada sesión</div>
                  </div>
                </div>
              </div>
            </div>
            <p className="mt-3 text-[0.72rem] uppercase tracking-[0.24em]" style={{ color: COLOR.accentStrong }}>
          ...
          <div className="lg:col-span-7 lg:pl-6 reveal opacity-0 translate-y-8 transition-all duration-700">
            ...
            <h2 className="font-display mt-4 leading-[0.92]" style={{ color: COLOR.ink, fontSize: "clamp(2.5rem, 5.6vw, 5rem)" }}>
              Un estudio donde
      ...
      {/* ═════════ CLASES ═════════ */}
      <section id="clases" className="relative px-5 sm:px-8 lg:px-12 pb-20 lg:pb-28" style={{ backgroundColor: COLOR.canvas }}>
        <div className="mx-auto max-w-[1320px]">
          <div className="reveal opacity-0 translate-y-8 transition-all duration-700 mb-10 lg:mb-14">
            <span className="text-[0.66rem] font-medium uppercase tracking-[0.34em]" style={{ color: COLOR.accentStrong }}>
              Tu semana en Alma
            </span>
            <h2 className="font-display mt-4 leading-[0.92]" style={{ color: COLOR.ink, fontSize: "clamp(2.4rem, 5.2vw, 4.6rem)" }}>
              Evoluciona
          ...
          <ul className="reveal opacity-0 translate-y-8 transition-all duration-700 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-x-5 gap-y-10 list-none m-0 p-0" data-stagger>
            {classTypes.slice(0, 8).map((c, idx) => {
              ...
              const tileBg = idx % 3 === 0 ? COLOR.sunken : idx % 3 === 1 ? COLOR.inkMuted : COLOR.canvas;
              const layout = idx % 7;
              const span =
              ...
              return (
                <li key={c.id} className={span} data-stagger-item>
                  <div>
                    ...
                    >
                      <span className={"relative flex flex-col overflow-hidden rounded-[22px] p-6 sm:p-7 transition-transform duration-500 ease-out group-hover:-translate-y-1 " + minH} style={{ backgroundColor: tileBg, border: `1px solid ${COLOR.line}` }}>
                        <span className="flex items-center justify-between gap-3">
                          <span className="inline-flex items-center gap-2 rounded-full px-3 py-1 text-[0.6rem] uppercase tracking-[0.22em]" style={{ backgroundColor: COLOR.canvas, color: COLOR.accentStrong }}>
                            <span className="inline-block h-1.5 w-1.5 rounded-full" style={{ backgroundColor: COLOR.ink }} />
                        ...
                        <span className="block mt-auto pt-9">
                          <span className="block font-display leading-[0.9]" style={{ color: COLOR.ink, fontSize: "clamp(2rem, 3vw, 3rem)" }}>
                            {c.name}
                          </span>
                          {c.subtitle && (
                            <span className="mt-1.5 block font-display text-[0.98rem]" style={{ color: COLOR.accentStrong }}>
                              {c.subtitle}
                            </span>
                          )}
                          <span className="mt-4 flex flex-wrap items-center gap-x-4 gap-y-1 text-[0.62rem] uppercase tracking-[0.16em]" style={{ color: COLOR.ink, opacity: 0.5 }}>
      ...
      <section className="relative overflow-hidden px-5 sm:px-8 lg:px-12 py-32 lg:py-44" style={{ backgroundColor: COLOR.inverse }}>
        <div className="relative mx-auto max-w-[1100px] text-center reveal opacity-0 translate-y-8 transition-all duration-700">
          <span className="text-[0.66rem] font-medium uppercase tracking-[0.34em]" style={{ color: COLOR.canvas, opacity: 0.78 }}>
            Tu turno
          </span>
          <h2 className="font-display mt-5 leading-[0.86]" style={{ color: COLOR.canvas, fontSize: "clamp(2.8rem, 8vw, 6.5rem)" }}>
            Reserva tu clase muestra,
            <span className="block font-display font-normal mt-2" style={{ color: COLOR.sunken }}>te recibimos.</span>
          </h2>
          <p className="mt-7 mx-auto max-w-[52ch] text-[1.05rem] leading-[1.7]" style={{ color: COLOR.canvas, opacity: 0.88 }}>
          ...
          <div className="mt-9 flex flex-wrap items-center justify-center gap-4">
            ...
            >
              ...
              <span className="grid h-7 w-7 place-items-center rounded-full transition-transform group-hover:translate-x-1" style={{ backgroundColor: COLOR.ink, color: COLOR.canvas }}>
                <ArrowUpRight size={13} />
              </span>
            </button>
            <a
...
const CoachPhoto = ({
  ...
  if (!photoUrl) {
    return (
      <>
        ...
        <span
          className="relative grid place-items-center rounded-full font-display leading-none"
          style={{ width: isSolo ? 176 : 124, height: isSolo ? 176 : 124, backgroundColor: COLOR.canvas, color: COLOR.accentStrong, fontSize: isSolo ? "4rem" : "3rem" }}
        >
          {initialsOf(label)}
        </span>
      </>
  ...
  return (
    ...
    >
      ...
      {hasSecond && (
        <span className="pointer-events-none absolute bottom-3 right-3 grid h-7 w-7 place-items-center rounded-full bg-inverse/70 text-canvas text-[11px] opacity-80 sm:hidden">
          ↺
        </span>
      )}
    </div>
...
const CoachesSection = ({ instructors }: { instructors: { id: string; displayName: string; bio?: string; specialties?: string | string[]; photoUrl?: string; photoUrl_2?: string; photoFocusX?: number; photoFocusY?: number }[] }) => {
  ...
  return (
    <section id="coaches" className="relative overflow-hidden px-5 sm:px-8 lg:px-12 py-28 lg:py-40" style={{ backgroundColor: COLOR.line }}>
      <div className="relative mx-auto max-w-[1320px]">
        <div className="reveal opacity-0 translate-y-8 transition-all duration-700 flex flex-col lg:flex-row lg:items-end justify-between gap-6 mb-12">
          <div>
            <span className="text-[0.66rem] font-medium uppercase tracking-[0.34em]" style={{ color: COLOR.ink }}>
              Quién te va a recibir
            </span>
            <h2 className="font-display mt-4 leading-[0.92]" style={{ color: COLOR.ink, fontSize: "clamp(2.4rem, 5.2vw, 4.6rem)" }}>
              Te enseña
              <span className="block font-display font-normal" style={{ color: COLOR.inverse }}>alguien que te conoce por tu nombre.</span>
            </h2>
          </div>
          <p className="max-w-[40ch] text-[0.95rem] leading-[1.7]" style={{ color: COLOR.ink }}>
        ...
        <div className={"reveal opacity-0 translate-y-8 transition-all duration-700 grid gap-8 items-start " + (isSolo ? "grid-cols-1 lg:grid-cols-12" : items.length === 2 ? "grid-cols-1 sm:grid-cols-2" : "grid-cols-1 sm:grid-cols-2 lg:grid-cols-3")}>
          {items.map((inst) => (
            ...
            >
              <div className={(isSolo ? "lg:col-span-6 " : "") + "relative grid place-items-center overflow-hidden rounded-[24px] " + (isSolo ? "aspect-[5/4] lg:aspect-[16/11]" : "aspect-[4/5]")} style={{ backgroundColor: COLOR.sunken }}>
                <CoachPhoto
              ...
              <div className={isSolo ? "lg:col-span-6" : "mt-5"}>
                <span className="text-[0.62rem] uppercase tracking-[0.24em]" style={{ color: COLOR.ink }}>{inst.sub}</span>
                <h3 className="font-display mt-2 leading-[0.92]" style={{ color: COLOR.inverse, fontSize: isSolo ? "clamp(2.4rem, 4.4vw, 4rem)" : "clamp(1.7rem, 2.4vw, 2.4rem)" }}>
                  {inst.coachTitle}
                </h3>
                {inst.bio && (
                  <p className={"text-[0.95rem] leading-[1.75] max-w-[60ch] whitespace-pre-line " + (isSolo ? "mt-5" : "mt-3")} style={{ color: COLOR.ink }}>
                    {inst.bio}
                  </p>
                )}
              </div>
...
const PaquetesSection = ({
  ...
  return (
    <section id="paquetes" className="relative overflow-hidden px-5 sm:px-8 lg:px-12 py-28 lg:py-40" style={{ backgroundColor: COLOR.inverse }}>
      <div className="relative mx-auto max-w-[1320px]">
        <div className="reveal opacity-0 translate-y-8 transition-all duration-700 flex flex-col lg:flex-row lg:items-end justify-between gap-6 mb-12">
          <div>
            <span className="text-[0.66rem] font-medium uppercase tracking-[0.34em]" style={{ color: COLOR.canvas, opacity: 0.72 }}>
              Inversión
            </span>
            <h2 className="font-display mt-4 leading-[0.9]" style={{ color: COLOR.canvas, fontSize: "clamp(2.6rem, 6vw, 5.4rem)" }}>
              Un paquete
              <span className="block font-display font-normal" style={{ color: COLOR.sunken }}>para tu ritmo.</span>
            </h2>
          </div>
          <p className="max-w-[42ch] text-[0.95rem] leading-[1.7]" style={{ color: COLOR.canvas, opacity: 0.78 }}>
        ...
        {trialPlan && (
          <div className="reveal opacity-0 translate-y-8 transition-all duration-700 mb-10">
            <div className="rounded-[24px] p-7 sm:p-9 flex flex-col gap-5" style={{ backgroundColor: COLOR.canvas }}>
        ...
        <div className="reveal opacity-0 translate-y-8 transition-all duration-700">
          <div className="rounded-[24px] overflow-hidden" style={{ backgroundColor: COLOR.canvas }}>
            <div className="overflow-x-auto">
              <div className="min-w-[660px]">
                {/* encabezado de columnas */}
                <div className="grid items-end gap-x-3 px-6 sm:px-9 pt-8 pb-4" style={{ gridTemplateColumns: "1.5fr repeat(5, 1fr)" }}>
                  <span className="text-[0.7rem] uppercase tracking-[0.24em]" style={{ color: COLOR.accentStrong }}>
                    Por modalidad y sesiones
                  </span>
                  {COLS.map((c) => (
                    <span key={c.key} className="nums text-center text-[0.7rem] font-medium uppercase tracking-[0.12em]" style={{ color: COLOR.accentStrong }}>
                      {c.label}
                    </span>
                  ))}
                </div>
                {/* filas por modalidad */}
                {matrixRows.map((row) => (
                  <div key={row.label} className="grid items-center gap-x-3 px-6 sm:px-9 py-6" style={{ gridTemplateColumns: "1.5fr repeat(5, 1fr)", borderTop: `1px solid ${COLOR.line}` }}>
                    <div>
                      <h3 className="font-display leading-none" style={{ color: COLOR.ink, fontSize: "clamp(1.4rem, 2.1vw, 1.95rem)" }}>{row.label}</h3>
                      <p className="text-[0.7rem] uppercase tracking-[0.14em] mt-1.5" style={{ color: COLOR.accentStrong }}>{row.sub}</p>
                    </div>
                    {COLS.map((c) => {
                      const plan = row.plans.find(c.match);
                      if (!plan) return <div key={c.key} className="text-center text-[1.2rem]" style={{ color: `${COLOR.ink}26` }}>·</div>;
                      ...
                      return (
                        <button
                          ...
                          style={isInf ? { backgroundColor: `${COLOR.ink}14` } : undefined}
                        >
                          <div className="font-display nums leading-none" style={{ color: COLOR.accentStrong, fontSize: "clamp(1.25rem, 1.8vw, 1.6rem)" }}>
                            ${formatPrice(plan)}
                          </div>
                          <div className={"mt-1 text-[0.7rem] uppercase tracking-[0.14em]" + (isInf && plan.openingActive ? " font-medium" : "")} style={{ color: COLOR.accentStrong }}>
          ...
          <p className="sm:hidden text-center text-[0.7rem] uppercase tracking-[0.2em] mt-2" style={{ color: COLOR.canvas, opacity: 0.65 }}>
        ...
        <div className="reveal opacity-0 translate-y-8 transition-all duration-700 mt-12 grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-start">
          {premiumPlans.length > 0 && (
            <div className="lg:col-span-5 rounded-[24px] p-7 sm:p-9 flex flex-col justify-between min-h-[300px]" style={{ backgroundColor: COLOR.canvas }}>
              <div>
                <span className="text-[0.7rem] font-medium uppercase tracking-[0.2em]" style={{ color: COLOR.accentStrong }}>
                  Todo el estudio
                </span>
              ...
              <div className="mt-8 flex items-end justify-between">
                <div className="flex items-baseline gap-2">
                  <span className="font-display nums leading-none" style={{ color: COLOR.accentStrong, fontSize: "clamp(2.8rem, 4.6vw, 4rem)" }}>${formatPrice(premiumPlans[0])}</span>
                  <span className="text-[0.7rem] uppercase tracking-[0.16em]" style={{ color: COLOR.accentStrong }}>{premiumPlans[0].openingActive ? "apertura" : "MXN"}</span>
                </div>
                <button onClick={onPick} className="grid h-12 w-12 place-items-center rounded-full transition-transform hover:scale-105" style={{ backgroundColor: COLOR.ink, color: COLOR.canvas }} aria-label={`Elegir ${premiumPlans[0].name}`}>
          ...
          <div className="lg:col-span-7 flex flex-col">
            {amClubPlans.length > 0 && (
              <div className="pb-8" style={{ borderBottom: mixtoPlans.length > 0 ? `1px solid ${COLOR.canvas}22` : undefined }}>
                <div className="flex flex-wrap items-baseline justify-between gap-3">
                  <h3 className="font-display leading-none" style={{ color: COLOR.canvas, fontSize: "1.6rem" }}>AM Club</h3>
                  <span className="nums text-[0.7rem] uppercase tracking-[0.18em]" style={{ color: COLOR.canvas, opacity: 0.7 }}>Solo mañanas · 7–10am</span>
                </div>
                <p className="mt-2 text-[0.88rem] leading-[1.6] max-w-[52ch]" style={{ color: COLOR.canvas, opacity: 0.75 }}>8 clases al mes en horario matutino, a precio especial.</p>
                <div className="mt-4 flex flex-wrap gap-2.5">
                  {amClubPlans.map((p) => (
                    <button key={p.id} onClick={onPick} aria-label={`Elegir ${p.name}`} className="inline-flex items-center gap-3 rounded-full px-5 py-2.5 transition-transform hover:-translate-y-0.5" style={{ border: `1px solid ${COLOR.canvas}3d`, color: COLOR.canvas, backgroundColor: "transparent", cursor: "pointer" }}>
                      <span className="text-[0.82rem]">{p.name.includes("Reformer") ? "Reformer / Tower" : "Studio"}</span>
                      <span className="font-display nums text-[1.05rem] inline-flex items-center gap-1">${formatPrice(p)}<ArrowUpRight size={13} /></span>
                    </button>
                  ))}
                </div>
              </div>
            ...
            {mixtoPlans.length > 0 && (
              <div className={amClubPlans.length > 0 ? "pt-8" : ""}>
                <div className="flex flex-wrap items-baseline justify-between gap-3">
                  <h3 className="font-display leading-none" style={{ color: COLOR.canvas, fontSize: "1.6rem" }}>Paquetes mixtos</h3>
                  <span className="text-[0.7rem] uppercase tracking-[0.18em]" style={{ color: COLOR.canvas, opacity: 0.7 }}>Combina las dos áreas</span>
                </div>
                <p className="mt-2 text-[0.88rem] leading-[1.6] max-w-[52ch]" style={{ color: COLOR.canvas, opacity: 0.75 }}>Studio y Reformer/Tower en un mismo paquete.</p>
                <div className="mt-4 flex flex-wrap gap-2.5">
                  {mixtoPlans.map((p) => (
                    <button key={p.id} onClick={onPick} aria-label={`Elegir ${p.name}`} className="inline-flex items-center gap-3 rounded-full px-5 py-2.5 transition-transform hover:-translate-y-0.5" style={{ border: `1px solid ${COLOR.canvas}3d`, color: COLOR.canvas, backgroundColor: "transparent", cursor: "pointer" }}>
        ...
        <p className="reveal opacity-0 translate-y-8 transition-all duration-700 mt-6 text-[0.78rem] uppercase tracking-[0.18em] text-center" style={{ color: COLOR.canvas, opacity: 0.55 }}>
...
const PoliticasSection = () => {
  ...
  return (
    <section id="politicas" className="relative px-5 sm:px-8 lg:px-12 py-28 lg:py-40" style={{ backgroundColor: COLOR.canvas }}>
      <div className="mx-auto max-w-[1320px]">
        <div className="reveal opacity-0 translate-y-8 transition-all duration-700 grid grid-cols-1 lg:grid-cols-12 gap-10 mb-10">
          <div className="lg:col-span-5">
            ...
            <h2 className="font-display mt-4 leading-[0.92]" style={{ color: COLOR.ink, fontSize: "clamp(2.2rem, 4.6vw, 4rem)" }}>
              Reglas de la casa,
        ...
        <ul className="reveal opacity-0 translate-y-8 transition-all duration-700 list-none m-0 p-0">
          {items.map((it, i) => {
            ...
            return (
              <li key={it.num} style={{ borderTop: `1px solid ${COLOR.line}`, borderBottom: isLast ? `1px solid ${COLOR.line}` : undefined }}>
                <button
                  ...
                  aria-expanded={isOpen}
                >
                  <span className="font-display nums text-[1rem]" style={{ color: COLOR.accentStrong }}>{it.num}</span>
                  <h3 className="font-display tracking-tight leading-tight" style={{ color: COLOR.ink, fontSize: "clamp(1.3rem, 2.4vw, 2rem)" }}>
                    {it.title}
                  </h3>
                  <span className="grid h-9 w-9 place-items-center rounded-full transition-transform" style={{ backgroundColor: isOpen ? COLOR.ink : "transparent", color: isOpen ? COLOR.canvas : COLOR.accentStrong, border: `1px solid ${COLOR.accentStrong}` }}>
                    {isOpen ? <Minus size={14} /> : <Plus size={14} />}
                  </span>
                </button>
...
const TestimoniosSection = () => {
  return (
    <section className="relative px-5 sm:px-8 lg:px-12 py-28 lg:py-40" style={{ backgroundColor: COLOR.sunken }}>
      <div className="mx-auto max-w-[900px] text-center reveal opacity-0 translate-y-8 transition-all duration-700">
        <span className="text-[0.66rem] font-medium uppercase tracking-[0.34em]" style={{ color: COLOR.accentStrong }}>
          Nuestra filosofía
        </span>
        <blockquote className="mt-6 font-display leading-[1.04]" style={{ color: COLOR.ink, fontSize: "clamp(2rem, 4vw, 3.4rem)", fontWeight: 380 }}>
          “Aquí el movimiento te regresa a ti. En grupos pequeños, donde te conocen por tu nombre y{" "}
          <span className="font-display" style={{ color: COLOR.accentStrong }}>cada clase se siente como bienestar</span>.”
        </blockquote>
...
const ContactoSection = () => {
  ...
  return (
    <section id="contacto" className="px-5 sm:px-8 lg:px-12 py-28 lg:py-40" style={{ backgroundColor: COLOR.canvas }}>
      <div className="mx-auto max-w-[1320px] grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
        <div className="lg:col-span-5 reveal opacity-0 translate-y-8 transition-all duration-700 flex flex-col">
          ...
          <h2 className="font-display mt-4 leading-[0.92]" style={{ color: COLOR.ink, fontSize: "clamp(2.2rem, 4.6vw, 4rem)" }}>
            Plaza Arce,
            <span className="block font-display font-normal" style={{ color: COLOR.inkMuted }}>Juriquilla, Querétaro.</span>
          </h2>
          <ul className="mt-8 list-none m-0 p-0 grid gap-5">
            {items.map((it) => (
              <li key={it.label} className="grid grid-cols-[auto_1fr] items-start gap-4 py-3" style={{ borderTop: `1px solid ${COLOR.line}` }}>
                <span className="grid h-10 w-10 place-items-center rounded-full" style={{ backgroundColor: COLOR.sunken, color: COLOR.accentStrong }}>
                  {it.icon}
                </span>
                <div>
                  ...
                  {it.href ? (
                    ...
                    <div className="mt-1 text-[0.98rem] leading-[1.55]" style={{ color: COLOR.ink }}>{it.value}</div>
                  )}
                </div>
              </li>
            ))}
        ...
        <div className="lg:col-span-7 reveal opacity-0 translate-y-8 transition-all duration-700 overflow-hidden rounded-[24px] min-h-[420px] lg:min-h-[520px]" style={{ border: `1px solid ${COLOR.line}` }}>
          <iframe
...
const FooterSection = ({ scrollTo, navigate }: { scrollTo: (id: string) => void; navigate: (path: string) => void }) => {
  return (
    <footer className="relative overflow-hidden px-5 sm:px-8 lg:px-12 pt-20 pb-8" style={{ backgroundColor: COLOR.inverse, color: COLOR.canvas }}>
      <div className="relative mx-auto max-w-[1320px]">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-8 pb-10" style={{ borderTop: `1px solid ${COLOR.canvas}22` }}>
          ...
          <div className="pt-8">
            ...
            <ul className="flex flex-col gap-2 list-none m-0 p-0 text-[0.88rem]">
              ...
              <li><a href="mailto:info@almamovement.mx" className="opacity-80 hover:opacity-100 transition-opacity no-underline" style={{ color: COLOR.canvas }}>info@almamovement.mx</a></li>
              <li><a href={`https://wa.me/${STUDIO.whatsapp}`} target="_blank" rel="noopener noreferrer" className="opacity-80 hover:opacity-100 transition-opacity no-underline" style={{ color: COLOR.canvas }}>WhatsApp</a></li>
              <li><a href="https://www.instagram.com/movementalma/" target="_blank" rel="noopener noreferrer" className="opacity-80 hover:opacity-100 transition-opacity no-underline" style={{ color: COLOR.canvas }}>Instagram</a></li>
            </ul>
          </div>
        </div>

        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 pt-6 text-[0.74rem]" style={{ borderTop: `1px solid ${COLOR.canvas}22` }}>
