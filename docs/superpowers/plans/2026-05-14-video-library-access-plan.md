...
```bash
cd "/Users/saidromero/Desktop/Alma Movement/alma-movement"
git status
```
...
Find the line `const JWT_SECRET = process.env.JWT_SECRET || "dev_alma_secret_change_me";` (line ~30). Add immediately after:
...
const SECRET = process.env.JWT_SECRET || "dev_alma_secret_change_me";
